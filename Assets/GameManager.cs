        ...
        public IEnumerator TryConnect(int attempts, float interval)
        {
            ...
            for(int i = 0; i < attempts; i++)
            {
                ...
                if(networking != null)
                {
                    ...
                    BarkSingleton.Bark("ARDK Networking Ready");
                    networking.Connected += OnNetworkInitialized;
                    break;
                }
                else
                {
                    BarkSingleton.Bark("Attempt " + attempts + " to Connect to Network Object. Unsuccessful.");
        ...
        private void Update()
        {
            ...
            if(touch.phase == TouchPhase.Began)
            {
                ...
                if (currentFrame == null)
                {
                    ...
                    BarkSingleton.Bark("No Current Frame");
                    return;
                }
